...
<body class="bg-gradient-to-br from-red-50 via-white to-pink-50 min-h-screen flex items-center justify-center p-4 sm:p-6">

    <div class="max-w-2xl w-full text-center">

        <!-- 500 BIG TEXT -->
        <h1 class="text-7xl sm:text-8xl md:text-9xl font-extrabold text-transparent bg-clip-text 
                   bg-gradient-to-r from-red-600 to-pink-600 mb-6 animate-pulse">
            500
        </h1>
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center max-w-lg mx-auto px-4">
            ...
            <button onclick="window.location.reload()"
                    class="w-full sm:w-auto inline-flex items-center justify-center px-5 py-2.5 rounded-lg shadow-md
                           bg-white text-gray-900 font-semibold border-2 border-red-600 text-sm
                           transition-all duration-200 hover:bg-red-600 hover:text-white hover:shadow-xl hover:scale-[1.03]">
    ...
    <div class="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        <div class="absolute top-1/4 left-1/4 w-56 h-56 bg-red-200 rounded-full mix-blend-multiply blur-2xl opacity-25 animate-blob"></div>
        <div class="absolute top-1/3 right-1/4 w-56 h-56 bg-pink-200 rounded-full mix-blend-multiply blur-2xl opacity-25 animate-blob animation-delay-2000"></div>
        <div class="absolute bottom-1/4 left-1/3 w-56 h-56 bg-rose-200 rounded-full mix-blend-multiply blur-2xl opacity-25 animate-blob animation-delay-4000"></div>
    </div>
